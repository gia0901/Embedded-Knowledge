...
- ⚠️ **[config.md §6 — Hợp đồng ĐỘ SÂU](14-prep/mock-interview/config.md) (BẮT BUỘC đọc trước mọi phiên):** luật chống phiên mock nông. Cốt lõi — **mọi câu** (mới / weak / retention) đều phải có **phần nền + phần follow-up mở rộng**; nguồn câu chỉ đổi *trọng số* giữa hai phần (câu weak: nén nền còn 1 checkpoint, điểm gần như hoàn toàn từ follow-up). Kèm: hỏi qua snippet cụ thể thay vì định nghĩa, bắt viết code rồi review chính code đó, biên dịch chạy thật trước khi khẳng định. Lan can: **sâu ≠ trivia**.
