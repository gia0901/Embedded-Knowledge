...
- **Vị trí:** ✅ **XONG D1** + **3 phiên ngoài lịch** (`resume` 18/08 → RES 100% · `bsp` 19/08 → BSP 40% · **`cpp-system` 21/08 → trả xong NỢ RETENTION**). Còn **BEH 0%** là domain trắng cuối cùng. Xem ▶️ LÀM TIẾP.
...
- **Buổi gần nhất:** `daily track cpp-system` — **3.0/4**, 6 câu ([log](../mock-interview/sessions/2026-08-21--daily--cpp-system.md)). ⏰ **TRẢ XONG NỢ RETENTION** trước hạn chót 2 ngày. Cơ cấu lệch chuẩn có chủ đích: **4 retention + 2 weak** (daily mặc định chỉ 1 slot revisit) theo chỉ thị §📍 — hợp lệ vì [config §⚖️](../mock-interview/config.md) cho plan quyết định *hỏi cái gì*. Điểm: CPP-009 **4** · DP-002 **1** 🔴 · OS-003 **3** · OS-007 **4** · CPP-032 **3** · CPP-016 **3**. **Chuyển động sổ yếu:** 🎉 gỡ **CPP-032** (2 lần liên tiếp ≥3, đã xếp lịch 04–09/09) · CPP-016 2→3 · 🔻 **DP-002 kéo về sổ yếu** (regression 4→1).
...
- **📊 ĐỘ PHỦ đo lại 21/08:** **149/411 = 36%** *(phiên 21/08 toàn câu đã hỏi ⇒ phủ **không tăng**; bank +1 câu mới `DP-020`)*. RES **100%** · CPP 72% · LNX 60% · **BSP 40%** ⬆️ *(7%)* · OS 39% · DBG 31% · COD 30% · DRV 30% · BUS 29% · BLD 26% · DP 21% · DSA 12% · SD 12% · **EMB 3%** · **NET 0%** · **BEH 0%**.
...
- **Sổ yếu (11 câu — cập nhật 21/08):** **LNX-040 (0đ)** *(⚠️ repo chưa có tài liệu — viết doc trước khi hỏi lại)* · **DP-002 (4→1** 🔻 **regression mới)** · **LNX-026 (2đ)** · LNX-005 (2đ, **đứng yên 2 phiên** — lần sau **bắt viết code**) · LNX-029 (1→2đ) · CPP-016 (2→**3**, 1/2 lần ≥3) · SD-016 (1/2 lần ≥3) · CPP-054 (chưa hỏi lại) · **LNX-024 (0→3**, mới đạt ở T1, lần sau phải hỏi **T2)** · OS-020 (1/2 lần ≥3) · BSP-021 (2đ) · BSP-029 (2đ) · RES-012 (2đ). 🎉 **Gỡ 21/08: CPP-032** (2 → 2 → 3 → 3). Xem [weak-register](../mock-interview/weak-register.md).
