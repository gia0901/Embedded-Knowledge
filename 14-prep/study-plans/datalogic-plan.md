...
- **▶️ LÀM TIẾP:** **Tuần 2 Buổi 3** — 🔁 khởi động 5–10′ bằng **LNX-024** (namespaces/cgroups — trắng 0đ; ⚠️ **đọc bank trước, repo chưa có tài liệu topic**) → đọc [09-debugging](../../09-debugging/): [gdb](../../09-debugging/gdb.md), [tools](../../09-debugging/tools.md) (strace/ltrace/perf), [memory-bugs](../../09-debugging/memory-bugs.md) → `/mock daily track debugging`.
- **Nợ lại:**
...
- **Sổ yếu (11 câu):** **LNX-024 (0đ)** 🆕 · **LNX-040 (0đ)** 🆕 *(⚠️ hai câu này repo chưa có tài liệu — viết doc trước khi hỏi lại)* · **LNX-026 (2đ)** 🆕 · LNX-005 (2đ, **đứng yên 2 phiên**) · LNX-029 (1→2đ) · CPP-016 · SD-016 · CPP-054 (chưa hỏi lại) · LNX-023 (0→3, **1/2 lần ≥3**) · OS-020 (1/2 lần ≥3) · CPP-032 (1/2 lần ≥3). Xem [weak-register](../mock-interview/weak-register.md).
