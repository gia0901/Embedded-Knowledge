...
- **Vị trí:** ✅ **XONG Tuần 2 · Buổi 1** (12/12 câu, chạy làm 2 lần trong ngày). Tiếp theo là **Buổi 2** (io-multiplexing + IPC).
- **Buổi gần nhất:** `rapid track linux-sysprog` (T2·B1, trần T2) — **2.67/4**, 12 câu ([phần 1](../mock-interview/sessions/2026-08-13--rapid--linux-sysprog.md) 3 câu · [phần 2](../mock-interview/sessions/2026-08-13--rapid--linux-sysprog-2.md) 9 câu). **Phân bố rất lệch:** LNX-012 **4** ⭐ · LNX-017 **4** ⭐ · LNX-007/022/008/020/004/028 **3** · OS-020 **2→3** · LNX-005 **2** · LNX-029 **1** · LNX-023 **0**. Sổ yếu **5 → 8**. Sinh câu bank mới **LNX-030**. *(B1: 3.25 · B2: 3.3 · B3: 2.83 · B4: 3.17 · B5: 3.67 · CN-weak: 3.0 · CN-comp: 3.0 · T2B1: 2.67)*
- **▶️ LÀM TIẾP:** **Tuần 2 Buổi 2** — 🔁 khởi động 5–10′ bằng **LNX-023** (`/proc`, `/sys` — trắng 0đ, ưu tiên cao nhất) → đọc [io-multiplexing](../../04-linux-system-programming/io-multiplexing.md) (select/poll/epoll, **LT vs ET**) + [ipc-linux](../../04-linux-system-programming/ipc-linux.md) → `/mock by-level 🟠 track linux-sysprog`.
- **Nợ lại:**
...
- **Sổ yếu (8 câu):** **LNX-023 (0đ — ưu tiên số 1)** 🆕 · **LNX-029 (1đ)** 🆕 · CPP-016 · SD-016 · CPP-054 (chưa hỏi lại) · LNX-005 · OS-020 (1/2 lần ≥3) · CPP-032 (1/2 lần ≥3). Xem [weak-register](../mock-interview/weak-register.md).
...
- **Tuần 2** (Linux sysprog+debug): `[x]` B1 *(2.67 — 12 câu, 2 lượt)* · `[ ]` B2 ⬅️ **ĐANG Ở ĐÂY** · `[ ]` B3 · `[ ]` B4 · `[ ]` B5 · `[ ]` CN
