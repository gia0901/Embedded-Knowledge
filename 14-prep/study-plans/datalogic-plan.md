...
- **⚙️ TÀI LIỆU MỚI 2026-08-28 (thứ hai trong ngày) — [06/ci-and-test-farm.md](../../06-build-systems/ci-and-test-farm.md)** (13 mục · 12 bẫy · 21 bảng · có **§1 Khái niệm nền**). Bank theo cùng: **[BLD-020…036](../mock-interview/bank/build-systems.md)** — mục *E — CI cho embedded & test farm* **1 → 18 câu**; domain `BLD` **19 → 36**.
  ...
  - 📉 **Mẫu số độ phủ đã đổi:** bank **425 → 446 câu** (BLD **19 → 36**, BSP **39 → 44**). Con số *162/415 = 39%* đo ngày 24/08 ở trên là **bản ghi lịch sử**, đừng dùng lại — đo lại bằng lệnh ở [bank/README](../mock-interview/bank/README.md#đếm-câu--tính-bằng-lệnh-không-chép-tay). `BLD` vốn đã ở **26%** (thấp), nay mẫu số tăng ⇒ **phủ `BLD` tụt tiếp** và cần một phiên `track bsp`/`cpp-system` chạm vào mục E.
