...
| Mục | Nội dung | Câu |
|---|---|---|
| **A** | Bộ nhớ, con trỏ & UB | 7 |
| **B** | OOP, kế thừa & vtable | 13 |
| **C** | RAII & smart pointer | 7 |
| **D** | Move semantics & value category | 8 |
| **E** | Template & generic programming | 5 |
| **F** | Lambda & functional | 3 |
| **G** | Concurrency (chuẩn C++) | 5 |
| **H** | C++17, container & ABI | 4 |
| **I** | Từ *Effective Modern C++* (Scott Meyers) — track `emc` | 12 |
...
## D — Move semantics & value category
