...
> Domain `NET`. Track dùng: `networking`, `cpp-system`, `bsp`.
> 📑 Thứ tự theo **chủ đề** (mục A, B, C…), không theo số ID — thêm câu mới đặt vào đúng mục ([vì sao](README.md#-id--vị-trí-trong-file)).

| Mục | Nội dung | Câu |
|---|---|---|
| **A** | TCP/IP & tầng giao vận | 5 |
| **B** | Socket & giao thức ứng dụng | 7 |

---

## A — TCP/IP & tầng giao vận

#### NET-002 · 🟢 · concept · [→ tcp-ip](../../../13-networking/tcp-ip.md)
...
#### NET-001 · 🟢 · concept · [→ tcp-ip](../../../13-networking/tcp-ip.md)
...
#### NET-004 · 🟡 · concept · [→ tcp-ip](../../../13-networking/tcp-ip.md)
...
#### NET-005 · 🟡 · concept · [→ tcp-ip](../../../13-networking/tcp-ip.md)
...
#### NET-008 · 🟠 · concept · [→ tcp-ip](../../../13-networking/tcp-ip.md)
...
## B — Socket & giao thức ứng dụng

#### NET-003 · 🟢 · concept · [→ sockets-and-protocols](../../../13-networking/sockets-and-protocols.md)
...
#### NET-007 · 🟠 · concept · [→ sockets-and-protocols](../../../13-networking/sockets-and-protocols.md)
...
#### NET-009 · 🟠 · design · [→ sockets-and-protocols](../../../13-networking/sockets-and-protocols.md), [io-multiplexing](../../../04-linux-system-programming/io-multiplexing.md)
...
#### NET-006 · 🟡 · concept · [→ sockets-and-protocols](../../../13-networking/sockets-and-protocols.md)
...
#### NET-011 · 🔴 · concept · [→ sockets-and-protocols](../../../13-networking/sockets-and-protocols.md)
...
#### NET-010 · 🔴 · concept · [→ sockets-and-protocols](../../../13-networking/sockets-and-protocols.md)
...
#### NET-012 · 🔴 · concept · [→ sockets-and-protocols](../../../13-networking/sockets-and-protocols.md)
