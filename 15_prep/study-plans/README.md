...
| 🎯 **Embedded Linux Engineer @ Datalogic** (JD cụ thể) **← ĐANG CHẠY** | [datalogic-plan.md](datalogic-plan.md) — **resume ở §📍 Tiến độ (đầu file)** | 4 tuần (dùng được cho 2 tuần nước rút): C++17, Linux sysprog+debug, kernel/driver I2C/SPI + **PCI/USB**, **Yocto**/CMake/CI, design + lead/review |
