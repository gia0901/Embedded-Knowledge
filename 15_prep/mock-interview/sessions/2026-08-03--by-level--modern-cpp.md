...
- **Tài liệu:** > "Cách C++98 (khai báo private, không implement) chỉ chặn ở **link time** và chỉ với code ngoài class." ([EMC Item 11:444](../../../16-book-summaries/effective-modern-cpp.md#L444))
  > ```cpp
