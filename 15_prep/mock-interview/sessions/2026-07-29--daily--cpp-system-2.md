...
- **Tài liệu:** > "Chuẩn C++11 **bắt buộc**: nếu nhiều luồng cùng vào lần đầu, chỉ một luồng chạy khởi tạo, các luồng còn lại **chờ**... guard variable ẩn... Sau lần đầu chỉ là một atomic load." ([creational.md §Vì sao Meyers thread-safe](../../../12-design-patterns/creational.md))
