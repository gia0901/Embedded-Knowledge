...
| [daily-plan.md](daily-plan.md) | Lịch mock 4 tuần sprint (~5 buổi/tuần) |
...
Toàn bộ câu hỏi đã **gộp về [bank/](bank/)**. Các bộ câu hỏi cũ giờ là **con trỏ** trỏ về bank:
- [11-interview-questions/](../../11-interview-questions/) — theo topic.
- [technical_round/](../technical_round/) — bank prep mid-level (02/04) + behavioral (03).

Không tự học từ nhiều nơi nữa — mọi câu ở một chỗ, mọi nơi khác chỉ link tới.
